...
remapped_subset = RemappedDataset(subset, idx_map)
train_loader = DataLoader(remapped_subset, batch_size=BATCH_SIZE, shuffle=True)
...
# --- Save model ---
torch.save(model, "spider_classifier_3_full.pt")
print("\nModel saved to spider_classifier_3_full.pt")
